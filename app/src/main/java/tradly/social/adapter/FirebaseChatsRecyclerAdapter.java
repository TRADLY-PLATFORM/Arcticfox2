 ...
 */
public abstract class FirebaseChatsRecyclerAdapter<ViewHolder extends RecyclerView.ViewHolder, T> extends RecyclerView.Adapter<ViewHolder> {
     ...
     */
    public FirebaseChatsRecyclerAdapter(Query query) {
    ...
    protected abstract boolean shouldSkip(T obj);
    ...
    public void detachChildListener(DatabaseReference chatThreadReference){
        chatThreadReference.removeEventListener(mListener);
    }
}